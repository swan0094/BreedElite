  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        if (constraints.maxWidth <= BreedEliteBreakpoints.small) {
          return small(context, child);
        } else if (constraints.maxWidth <= BreedEliteBreakpoints.medium) {
          return (medium ?? large).call(context, child);
        } else if (constraints.maxWidth <= BreedEliteBreakpoints.large) {
